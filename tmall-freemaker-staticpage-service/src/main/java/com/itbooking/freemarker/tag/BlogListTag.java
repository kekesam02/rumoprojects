package com.itbooking.freemarker.tag;//package com.itbooking.freemarker.tag;
//
...
//		Integer courseId = TmTemplateDirectiveModelUtil.getInteger("courseId", params);
