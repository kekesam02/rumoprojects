...
public class MD5Util {
	...
	public static void main(String[] args) {
		...
		System.out.println(inputPassToFormPass("mkxiaoer19860207"));// 11dad9c3d844b8f7eac85c9e4e6de267
		System.out.println(formPassToDBPass(inputPassToFormPass("mkxiaoer19860207"), salt));
		System.out.println(inputPassToDbPass("mkxiaoer19860207", salt));// b7797cce01b4b131b433b6acf4add449
	}
}
