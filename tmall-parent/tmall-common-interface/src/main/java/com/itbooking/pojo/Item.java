...
public class Item  implements Serializable{
    ...
    public static class ItemBuilder{
	    ...
	    private String seller;
 	    ...
 	    public Item build(){
 	      return new Item(id,title,sellPoint,price,stockCount,num,barcode,image,categoryid,status,createTime,updateTime,itemSn,costPirce,marketPrice,isDefault,goodsId,sellerId,cartThumbnail,category,brand,spec,seller);
 	    }
