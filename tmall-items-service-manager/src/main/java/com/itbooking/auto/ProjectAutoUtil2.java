...
public class ProjectAutoUtil2 {
	...
	//定义模块
	private static	String beanModel = "Item";
	private static	String tablename = "tb_item";
	private static	String model = beanModel.toLowerCase();
	private static String author = "xuchengfeifei";
	private static String description = "商品管理";
	...
	public static List<Map<String,String>> loadTable() {
		try {
			...
			Connection connection = DriverManager.getConnection("jdbc:mysql://120.78.157.57:3306/tmall?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull", "root","mkxiaoer1986.");
	...
	public static void main(String[] args) throws IOException {
		...
		String pojo = "src/main/java/com/itbooking/pojo";
		loadTemplate(maps,pojo,beanModel+".java","pojo.tml");
		String mapper = "src/main/java/com/itbooking/mapper";
		...
		//service
		String service = "src/main/java/com/itbooking/service/"+model;
		loadTemplate(maps,service,"I"+beanModel+"Service.java","service.tml");
		String serviceimpl = "src/main/java/com/itbooking/service/"+model;
		loadTemplate(maps,serviceimpl,beanModel+"ServiceImpl.java","serviceImpl.tml");
		
		//vo
		//String vo = "src/main/java/com/itbooking/vo";
		//loadTemplate(maps,vo,beanModel+"Vo.java","vo.tml");
		
		//controller
		String controller = "src/main/java/com/itbooking/controller/"+model;
		...
		//listtag
		//String listtag = "src/main/java/com/itbooking/tag/"+model;
		//loadTemplate(maps,listtag,beanModel+"ListTag.java","listtag.tml");
		
		//benatag
		//String benatag = "src/main/java/com/itbooking/tag/"+model;
